      ...
      blocks: [
        {
          ...
          frame: "polaroid",
          placement: { x: 38, y: 42, rotate: -5, width: 58, z: 1 },
        },
        {
          id: "p2-note",
          kind: "text",
          ...
          font: "hand",
          tape: "stripe",
          placement: { x: 68, y: 76, rotate: 4, width: 50, z: 2 },
        },
      ],
      decorations: [
        { id: "p2-d1", kind: "pin", variant: "paperclip", placement: { x: 63, y: 16, rotate: -8, width: 8, z: 5 } },
        { id: "p2-d2", kind: "sticker", emoji: "🌊", placement: { x: 14, y: 78, rotate: -8, width: 13 } },
        { id: "p2-d3", kind: "doodle", shape: "swirl", placement: { x: 88, y: 60, width: 11 } },
      ],
    },
    {
      id: "p3",
      ...
      decorations: [
        { id: "p3-d1", kind: "doodle", shape: "star", color: "var(--color-dusk)", placement: { x: 15, y: 15, width: 10 } },
        { id: "p3-d2", kind: "sticker", emoji: "🎧", placement: { x: 84, y: 18, rotate: 5, width: 13 } },
        { id: "p3-d3", kind: "tape", variant: "gingham", placement: { x: 50, y: 10, rotate: 2, width: 20 } },
      ],
    },
  ],
};
